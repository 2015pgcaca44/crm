            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand desk_width" href="{{ url('/') }}">
                        <!-- {{ config('app.name', 'KPD') }} -->
                        <div class="span4 header mob_width marg_desk"><img class="pull-left" src="{{asset('images/logo-footer.png')}}" height="40px;" width="40px;" style="margin-top: -5px;">
                        <h3 style="color: #fff;" nowrap="nowrap">kpdigiteers.com </h3></div>
                    </a>
                </div>
