...
<div class="w3-container col-md-12 w3-mobile">
   <!-- <h3 style="margin-top: -3px;">My Tasks</h3> -->
   <div style="width: 100%;">
      <div class="panel panel-default w3-mobile" style="width: 100% margin-top:40px;">
        ...
        <div class="panel-body w3-mobile">
         ...
         <table id="dtBasicExample" class="table table-sm w3-small w3-mobile" style="width: 105%; overflow-x:auto;">
            <thead>
               <br />
               <tr class="bg-primary">
                  ...
                  <!-- <th scope="col" style="width: 13%; color: #fff;" nowrap="nowrap">Project Name</th> -->
                  ...
                  <th scope="col" style="width: 20%; color: #fff;" nowrap="nowrap">Description</th>
                  <th scope="col" style="width: 20%; color: #fff;">status</th>
            ...
            <tbody>
               ...
               <tr class="w3-hover-pale-green">
                  ...
                  <td style="padding-left: 20px;"><a class="btn btn-sm pull-right" data-toggle="modal" data-target="#{{ $id }}"><img class="pull-left" src="./images/edit_icon1.png" height="20px;" width="20px;"></a></td>
                     ...
                     <form class="form-horizontal" method="post" action="{{url('tasks_insert')}}">
                        ...
                        <div class="container col-sm-6 w3-mobile" style="width: 50%;">
                          ...
                          <!--  <div class="form-group">
                           ...
                           <div class="form-group">
                              <label for="leads_name" class="col-sm-4 control-label" style="margin-right: 13px;">Leads Name<font color="red" size="2" >*</font></label>
                              <!-- <div class="col-sm-6"  style="width: 65%;">
                           ...
                           <div class="form-group">
                              <label for="sources" class="col-sm-4 control-label">Sources<font color="red" size="2">*</font></label>
                           ...
                           @endphp
                           <div class="form-group">
                              <label for="budget" class="col-sm-4 control-label" style="margin-right: 150px;">Budget<font color="red" size="2">*</font></label>
                              <div class="col-sm-6 w3-mobile"  style="width: 65%; margin-left: -150px;">
                                 <input type="text" value="{{ $task_budget }}" name="budget" id="budget" placeholder="budget" class="form-control"></input>
                              </div>
                           </div><br /><br />
                           <div class="form-group">
                        ...
                        @endphp
                           ...
                           <div class="form-group">
                              <label for="approved_amount" class="col-sm-4 control-label">Approved Amount</label>
                              <div class="col-sm-6 w3-mobile"  style="width: 65%;">
                                 <input type="text" value="{{ $approved_amount }}" name="approved_amount" id="approved_amount" placeholder="approved_amount" class="form-control"></input>
                              </div>
                           </div><br /><br />
                          <!--  <div class="form-group">
                              <label for="linkdin" class="col-sm-4 control-label">Rating</label>
                        ...
                        <div class="container col-sm-6 w3-mobile"  style="width: 50%;">
                           <div class="form-group">
                              <label for="start_date" class="col-sm-4 control-label">Start Date</label>
                              <div class="col-sm-6 w3-mobile"  style="width: 65%;">
                                 <input type="date" value="{{ $start_date }}" name="start_date" id="start_date" placeholder="select_date" class="form-control"></input>
                              </div>
                           </div><br /><br />
                           <div class="form-group">
                              <label for="end_date" class="col-sm-4 control-label">End Date</label>
                              <div class="col-sm-6 w3-mobile"  style="width: 65%;">
                                 <input type="date" value="{{ $end_date }}" name="end_date" id="end_date" placeholder="select_date" class="form-control"></input>
                              </div>
                           </div><br /><br />
                           @php
                     }
                           @endphp
                           <div class="form-group green-border-focus w3-mobile">
                              <label for="description" class="col-sm-4 control-label">Description<font color="red" size="2">*</font></label>
                              <div class="col-sm-6 w3-mobile"  style="width: 65%;">
