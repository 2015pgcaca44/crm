...
<div class="w3-container col-md-12 w3-mobile" style = "overflow-y:auto;">
   <div style="width: 100%;">
      <a class="btn btn-sm btn-primary pull-right" data-toggle="modal" data-target="#addSales"  style="width: 8%;margin-top: 4px;margin-right: 4px;"><span class="glyphicon glyphicon-plus"></span>
      ...
      <div class="modal" id="addSales">
         <div class="modal-dialog w3-mobile" style="width: 60%;">
            <div class="modal-content w3-mobile">
               <!-- Modal Header -->
               <div class="modal-header w3-mobile">
                  <font class="modal-title" size="5" style="color: #1A20D9;">Add Salesman</font>
                  <button type="button" class="close" data-dismiss="modal">&times;</button>
               </div>
               <!-- Modal body -->
               <div class="modal-body w3-mobile">
                  <div class="panel-body w3-mobile">
                     <form class="form-horizontal" method="post" action="{{url('insert_sales')}}" role="form" style="background-color: #fff;">
            {{ csrf_field() }}
            ...
            <div class="container col-sm-12 w3-mobile">
                ...
                <div class="form-group">
                    <div class="col-sm-12 pull-right w3-mobile"  style="width: 60%;">
                        <span class="help-block">Required fields<font color="red" size="3">*</font></span>
                    </div>
                </div>
         ...
         <table id="dtBasicExample" class="table table-sm w3-small w3-mobile" style="margin-top: 10px;overflow-x:auto;">
            <thead style="width: 100%;">
               <tr class="bg-primary">
                  ...
                  <th style="color: #fff;" nowrap="nowrap">Joining Date</th>
                  ...
                  <th style="color: #fff;" nowrap="nowrap">Client Name</th>
            ...
            <tbody>
               ...
               $contact_name1 = \App\Customer::where(['id' => $client_id])->pluck('name');
                $client_name = trim($contact_name1,'["]');
            }
               @endphp
               <tr class="w3-hover-pale-green">
                  ...
                  <td style="color: #000000;">{{$data->gender}}</td>
         ...
         <div class="modal-dialog w3-mobile" style="width: 60%;">
            <div class="modal-content w3-mobile">
               ...
               <div class="modal-body w3-mobile" id="edit_inc">
                  <div class="panel-body w3-mobile">
                     <form class="form-horizontal" method="post" action='edit_sales/{{ $id }}'>
                        {{ csrf_field() }}
                        <!-- <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>"> -->
                        <div class="container col-sm-12 w3-mobile" style="width: 70%;">
                           <div class="form-group">
              ...
              <!--  <div class="modal-footer">
                  ...
                  <button type="button" class="btn btn-primary" onclick="document.getElementById('editSales').style.display = 'none';" data-dismiss="modal">Close</button><br />
               </div> -->
            </div>
         </div>
      </div>
